...
Note that for building and installing for Linux systems following instructions should be followed. For windows [download](https://github.com/bits2zbytes/adaboost/blob/windowsSupportReadME/README%20-%20for%20windows.docx) this file.
